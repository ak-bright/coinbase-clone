...
function Navbar() {
  ...
  return (
    <header className="fixed top-0 w-full bg-white shadow-sm border-b z-50">
                          ...
                          {dropdownData[item].column2.map((entry) =>
                            entry.isHeader ? (
                              ...
                              >
                                <div className="mt-0.5 flex-shrink-0">{entry.icon}</div>
                                <div>
                                  <p className="font-semibold text-gray-900 text-base group-hover:text-blue-600 transition">{entry.title}</p>
                                  <p className="text-sm text-gray-500 mt-0.5">{entry.desc}</p>
                                </div>
                              </a>
                            )
